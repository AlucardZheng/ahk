...
Else
{
Send {G down}   ;自动按住强制移动键x，关闭强制移动down换up，down可改动
;SetTimer, Label1, 1100  ;动作条技能1键600毫秒连点，对应天谴技能，600可改动
SetTimer, Label3, 150  ;动作条技能3键600毫秒连点，对应律法技能，600可改动
SetTimer, Label2, 1200  ;动作条技能2键600毫秒连点，对应挑衅技能，600可改动
SetTimer, Label4, 1400  ;动作条技能4键600毫秒连点，对应勇士技能，600可改动
SetTimer, MouseLButton, 150  ;鼠标左键150毫秒连点，150可改动，只有这里需要改动
SetTimer, MouseRButton, 1000     ;鼠标右键600毫秒连点，钢甲手动触发，自动钢甲off换成600，off可改动
}
}
Return
